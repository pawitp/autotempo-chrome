...
(function() {
  ...
  describe('exchangeService', function() {
    ...
    var $httpBackend, $q, exchangeService, configService;
    ...
    describe('getExchangeFolder', function() {
      it('should send folder request and parse response', function(done) {
        $httpBackend
        ...
        exchangeService.getExchangeFolder().should.eventually.deep.equal(EXCHANGE_FOLDER).and.notify(done);
    ...
    describe('getExchangeAppointments', function() {
      ...
      it('should be able to parse response with category', function(done) {
        $httpBackend
      ...
      it('should be able to parse response without category', function(done) {
      $httpBackend
        .expect('POST', 'https://mail.example.com/ews/exchange.asmx', /CalendarView/)
